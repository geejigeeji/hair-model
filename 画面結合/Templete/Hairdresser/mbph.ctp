...
<div class="row text-white mx-5" >
  ...
  <div class="namelavel0 container">
           <div class="row">
               <h5 class="font-weight-bold text-white ml-2">岡林蓮</h5>
                    <div class="text-white ml-5">先着５名様　よろしこ</div>
                    </div>
    </div>
            <div class="jumbotron back20">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="col-4"><img class='img-responsive' src='../img/single2.PNG'>
                                </div> 
                            </div>
